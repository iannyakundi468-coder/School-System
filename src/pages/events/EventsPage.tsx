...
const MOCK_EVENTS = [
    ...
    { id: 2, title: 'Term 1 CBC Open Day', date: '2026-03-20', time: '02:00 PM', location: 'Main Hall', type: 'Academic', description: 'Exhibition of Form 3 projects and assessment reviews.' },
