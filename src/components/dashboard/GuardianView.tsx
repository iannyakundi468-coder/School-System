        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card className="bg-slate-900/40 border-t-4 border-t-sky-500">
                    ...
                    <Button variant="ghost" className="w-full mt-6 h-9 text-[10px] border border-white/5 hover:bg-white/5 font-bold uppercase tracking-widest text-sky-400" onClick={() => navigate('/history')}>
