        ...
        <div className="glass-card p-8 bg-gradient-to-br from-slate-900 to-indigo-950 text-white border-none shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-8">
                <div className="flex justify-between items-start">
                    ...
                    <div className="bg-indigo-500/20 text-indigo-400 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest border border-indigo-500/30">
                        Live Analysis
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-4">
                        <div className="p-4 bg-white/5 rounded-2xl border border-white/10 hover:border-sky-500/30 transition-all group/item">
                            <div className="flex items-center gap-3 mb-3">
                                <TrendingUp className="w-5 h-5 text-sky-400" />
                                <span className="text-xs font-bold uppercase tracking-wider text-slate-300">Revenue Forecast</span>
                            </div>
                            <p className="text-sm text-slate-300 leading-relaxed">
                                Our <span className="text-white font-bold italic">SmartFee™</span> algorithm predicts a <span className="text-indigo-400 font-bold">14.2% increase</span> in revenue next term based on current enrollment trends and retention metrics.
                            </p>
                            <div className="mt-4 flex items-center justify-between">
                                <span className="text-[10px] font-bold text-slate-500">ACCURACY SCORE: 94%</span>
                                <Button variant="ghost" className="h-8 px-3 text-[10px] font-bold text-sky-400 hover:bg-sky-500/10 rounded-lg">View Projection Map</Button>
                            </div>
                        </div>
                    ...
                    <div className="relative">
                        <div className="glass-card bg-indigo-500/5 border-indigo-500/10 p-6 h-full flex flex-col items-center justify-center text-center">
                            <div className="w-24 h-24 relative mb-4">
                                <PieChart className="w-full h-full text-indigo-500/20" />
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <span className="text-2xl font-bold text-indigo-400">82%</span>
                                </div>
                            </div>
                ...
                <div className="pt-6 border-t border-white/5 flex flex-col md:flex-row gap-4 items-center justify-between">
                    ...
                    <div className="flex gap-3">
                        ...
                        <Button className="btn-primary h-10 px-6 bg-sky-600 hover:bg-sky-700 shadow-sky-500/20 border-none">
                            Run Simulations
                        </Button>
                    </div>
                </div>
